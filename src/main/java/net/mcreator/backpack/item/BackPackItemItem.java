...
package net.mcreator.backpack.item;
...
import net.mcreator.backpack.gui.BackPackGui;
import net.mcreator.backpack.BackpackModElements;
...
@BackpackModElements.ModElement.Tag
public class BackPackItemItem extends BackpackModElements.ModElement {
	@ObjectHolder("backpack:back_pack_item")
	public static final Item block = null;
	public BackPackItemItem(BackpackModElements instance) {
		super(instance, 2);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BackPackGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("back_pack_item");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7cBack pack avec 27 slots avec max par pile de \u00A7d64 \u00A7c item"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Back Pack");
					}
